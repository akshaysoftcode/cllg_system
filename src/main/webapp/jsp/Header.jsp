	...
	<div style="height: 39px">
		<div >
			<div style="margin: 16px">
				<span style="font-size: 20px; font-family: sans-serif;" class="logo">College Attendance System</span>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	%>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<%=CASView.USER_REGISTRATION_CTL%>">Add Faculty</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<%=CASView.ASSIGN_FACULTY_CTL%>">Add Assign Faculty</a>
          <a class="dropdown-item" href="<%=CASView.ASSIGN_FACULTY_LIST_CTL%>">Assign Faculty List</a>
        </div>
      </li>
